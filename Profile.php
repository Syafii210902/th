...
<body>
    ...
    ?>
    <div class="pp">
        <i class="fa fa-user-circle-o" style="font-size:120px;"></i><h1><?php echo ucwords($row['username']) ?></h1>
        <div class="upload">
            <form action="" method="POST" enctype="multipart/form-data">
                <input type="text" name="namawisata" placeholder="Nama Wisata">
                <input type="file" name="gambar" id="gambar" accept="image/*">
                <label for="gambar">Choose a Photo</label>
                <button type="submit" name="upload">Upload</button>
            </form>
        </div>
    </div>
    <?php
    $result = mysqli_query($conn, "SELECT gambar FROM fotogallery WHERE iduser = '$iduser'");
    global $j;
    $j = 0;
            ...
            <?php for ($i=0; $i < $jumlahgambar; $i++) : ?>
                <div class="animasi">
                    ...
                    <div class="top-left">
                        ...
                        <div class="iconprofile"><?php echo ucwords($row['username']) ?></div>
